...
@section('content')
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form class="application-form" method="post" action="/application/edit">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="form_number" value="{{ $regdata['form_number'] }}">
                            <input type="hidden" name="user_id" value="{{ $user->id }}">
                            <input type="hidden" name="mobile_number" value="{{ $regdata['mobile_number'] }}">
                            <input type="hidden" name="application_status" value="222">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
