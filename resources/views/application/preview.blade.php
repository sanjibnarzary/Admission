...
@section('content')
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="progress">
                <div class="progress-bar" role="progressbar" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100" style="min-width:2em;width:35%">
                    35% Completed
                </div>
            </div>
            <center>
            ...
            <form class="" method="post" action="/application/edit">
                ...
                <input type="hidden" name="application_status" value="333">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <a type="submit" href="/application/edit" name="continue" class="btn btn-info btn-block">Edit</a>
                    </div>
                    <div class="col-sm-6">
